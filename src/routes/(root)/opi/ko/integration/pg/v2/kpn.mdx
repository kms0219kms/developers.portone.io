...
<Details>
  <Details.Summary>`paymentId`의 경우 영문 대/소문자 및 숫자만 허용됩니다.</Details.Summary>
...
<Details>
  <Details.Summary>결제 요청 시 면세금액 설정 시 우선 적용 안내</Details.Summary>
...
<Details>
  <Details.Summary>카드 관련 미지원 파라미터 안내</Details.Summary>
...
<Details>
  <Details.Summary>카드 다이렉트 호출 지원 카드사 안내</Details.Summary>
...
<Details>
  <Details.Summary>카드 다이렉트 이용 시 약관동의 절차 안내</Details.Summary>
...
<Details>
  <Details.Summary>간편결제 다이렉트 호출 지원 안내</Details.Summary>
...
<Details>
  <Details.Summary>네이버페이 다이렉트 호출 미지원</Details.Summary>
...
<Details>
  <Details.Summary>간편결제 관련 미지원 파라미터 안내</Details.Summary>
...
<Details>
  <Details.Summary>계좌이체 관련 미지원 파라미터 안내</Details.Summary>
...
<Details>
  <Details.Summary>현금영수증 발급 유형 지원 안내</Details.Summary>
...
<Details>
  <Details.Summary>가상계좌 관련 미지원 파라미터 안내</Details.Summary>
...
<Details>
  <Details.Summary>가상계좌 사용시 입금통보 URL 설정 안내</Details.Summary>

  <Details.Content>
    한국결제네트웍스(KPN)의 경우, 가상계좌를 사용하는 경우 입금통보 URL을 별도로 설정해야 합니다.

    자세한 내용은 [가상계좌 입금통보 URL 설정 가이드](/opi/ko/integration/virtual-account/readme?v=v2#notice-config-kpn)를
    참조해 주세요.
  </Details.Content>
</Details>

<Details>
  <Details.Summary>가상계좌 지원 은행 안내</Details.Summary>
...
<Details>
  <Details.Summary>필수 입력 파라미터 안내</Details.Summary>
...
<Details>
  <Details.Summary>휴대폰 소액결제 관련 미지원 파라미터</Details.Summary>
...
<Parameter scope="browser-sdk/resources/request/PaymentRequest" flatten>
  - storeId: string
...
<Details>
  <Details.Summary>파라미터 입력 형식 안내</Details.Summary>

  <Details.Content>
    SDK를 통한 빌링키 발급 요청 시 `offerPeriod` 파라미터를 사용하여 결제창 내에 제공 기간을 표시할 수 있습니다.
    해당 파라미터는 range형태로만 입력 가능합니다.

    구체적인 형식은 SDK 가이드를 참고해주세요. [결제요청 파라미터 가이드 바로가기](/docs/ko/v2-payment/v2-sdk/payment-request?v=v2)
  </Details.Content>
</Details>
...
<Details>
  <Details.Summary>카드 다이렉트 호출 미지원 안내</Details.Summary>
...
<Details>
  <Details.Summary>카드 정보 입력 파라미터 안내</Details.Summary>
...
<Details>
  <Details.Summary>가상계좌 에스크로 결제 미지원 안내</Details.Summary>
...
<Details>
  <Details.Summary>부가세 지정금액 결제 미지원</Details.Summary>
...
<Details>
  <Details.Summary>환불서비스 신청 안내</Details.Summary>
